...
#         """
#         print "正在下载数据...."
#         url = "https://www.dingdiann.com/ddk38807/2520937.html"
...
#         pattern = re.compile('<div\sid="co(.*?)t">', re.S)
...
def saveBook():
	...
	content = xhtml.xpath('//div[@id="content"]/text()')
	# print(content)
	for b in content:
		with open('fanren.txt','a') as f:
